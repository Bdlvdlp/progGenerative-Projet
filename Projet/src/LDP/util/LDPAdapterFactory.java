...
public class LDPAdapterFactory extends AdapterFactoryImpl {
	...
	protected LDPSwitch<Adapter> modelSwitch =
		new LDPSwitch<Adapter>() {
			...
			@Override
			public Adapter caseInstantiationObjet(InstantiationObjet object) {
				return createInstantiationObjetAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link LDP.ElementProcessus <em>Element Processus</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link LDP.InstantiationObjet <em>Instantiation Objet</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createInstantiationObjetAdapter() {
		return null;
	}
