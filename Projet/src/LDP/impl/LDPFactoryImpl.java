...
public class LDPFactoryImpl extends EFactoryImpl implements LDPFactory {
	 ...
	 */
	@Override
	public InstantiationObjet createInstantiationObjet() {
		InstantiationObjetImpl instantiationObjet = new InstantiationObjetImpl();
		return instantiationObjet;
	}
