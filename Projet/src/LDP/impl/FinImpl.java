 ...
 * </p>
 * <ul>
 *   <li>{@link LDP.impl.FinImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FinImpl extends PseudoEtatImpl implements Fin {
	/**
	...
	protected EClass eStaticClass() {
		return LDPPackage.Literals.FIN;
	}
		...
		if (reference != null && reference.eIsProxy()) {
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LDPPackage.FIN__REFERENCE, oldReference, reference));
			}
		}
		return reference;
	}
	...
	public void setReference(ElementProcessus newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDPPackage.FIN__REFERENCE, oldReference, reference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDPPackage.FIN__REFERENCE:
