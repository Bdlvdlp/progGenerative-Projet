 ...
 *   <li>{@link LDP.impl.ProcessusImpl#getElements <em>Elements</em>}</li>
...
public class ProcessusImpl extends MinimalEObjectImpl.Container implements Processus {
	...
	public EList<ElementProcessus> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<ElementProcessus>(ElementProcessus.class, this, LDPPackage.PROCESSUS__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LDPPackage.PROCESSUS__ELEMENTS:
