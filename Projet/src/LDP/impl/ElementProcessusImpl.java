 ...
 * </p>
 * <ul>
 *   <li>{@link LDP.impl.ElementProcessusImpl#getNom <em>Nom</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ElementProcessusImpl extends MinimalEObjectImpl.Container implements ElementProcessus {
	...
	protected EClass eStaticClass() {
		return LDPPackage.Literals.ELEMENT_PROCESSUS;
	}
	...
	public void setNom(String newNom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDPPackage.ELEMENT_PROCESSUS__NOM, oldNom, nom));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDPPackage.ELEMENT_PROCESSUS__NOM:
				return getNom();
		}
