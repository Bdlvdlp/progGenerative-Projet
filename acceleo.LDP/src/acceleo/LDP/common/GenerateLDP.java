...
/**
 * Entry point of the 'GenerateLDP' generation module.
 *
 * @generated
 */
public class GenerateLDP extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/acceleo/LDP/common/generateLDP";
     ...
     * @generated
     */
    public GenerateLDP(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateLDP(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateLDP generator = new GenerateLDP(modelURI, folder, arguments);
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        EPackage.Registry.INSTANCE.put("http://LDP/1.0", LDPPackage.eINSTANCE);
